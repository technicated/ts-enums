...
/**
 * Create a generic enum with six generic parameters given a specific shape and
 * an optional definition.
 *
 * This is the sixth generic variant of the `makeEnum` family of functions of
 * the `ts-enums` library, creating enums with six generic parameter. You must
 ...
 * of the enum.
 *
 * The `makeEnum6` function automatically detects the "flavour" of your enum and
