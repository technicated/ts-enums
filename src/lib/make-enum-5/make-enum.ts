...
/**
 * Create a generic enum with five generic parameters given a specific shape and
 * an optional definition.
 *
 * This is the fifth generic variant of the `makeEnum` family of functions of
 * the `ts-enums` library, creating enums with five generic parameter. You must
 ...
 * of the enum.
 *
 * The `makeEnum5` function automatically detects the "flavour" of your enum and
 ...
 * ```
 */
export const makeEnum5 = base.makeEnum as MakeEnumFn
